      ...
      <div class="row">
        ...
        <div  class="sidebar" data-spy="affix">
          <ul class="nav nav-sidebar" >
            <li class="active"><a href="#">Informações Gerais<span class="sr-only">(current)</span></a></li>
            <li><a href="#">Meus alugueis</a></li>
            <li><a href="#">Agendar aluguel</a></li>
            <li><a href="#">Pendências</a></li>
            <li><a href="">Fale com a gerência</a></li>
          </ul>
        </div></div>
              <div>
